...
local layouts      = { "se","us","az" }

-- Packages some of the values into the awful.util table to make them global
awful.util.terminal     = terminal
awful.util.terminal_alt = terminal_alt
awful.util.editor       = editor
