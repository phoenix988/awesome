...
local mytextclock = wibox.widget.textclock(markup(theme.bg_normal, " %a") .. markup("#191724", " %d ") .. markup("#191724", "%b ") ..  markup("#161821", "%I:%M "))
...
local fsicon =  wibox.widget {
     markup = '<span foreground="#C4A7E7" font="Droid Sans 10">⛁</span>',
...
local cpuicon =  wibox.widget {
     markup = '<span foreground="#F6C177" font="Droid Sans 10">⧗</span>',
     widget = wibox.widget.textbox
}
...
local mem_icon =  wibox.widget {
     markup = '<span foreground="#EBBCBA" font="Droid Sans 10">🖬</span>',
     widget = wibox.widget.textbox
}
...
local bar_spr_middle   = wibox.widget.textbox(markup.font("Droid Sans 20", " ") .. markup.fontfg(theme.font, "#191724", "                         ") .. markup.font("Droid Sans 5", " "))
...
local col_bg =  wibox.widget {
     markup = '<span background="#191724" font="Droid Sans 25"> </span>',
     widget = wibox.widget.textbox
}

-- powerline seperators
local seperator = wibox.widget {
     markup = '<span foreground="#31748F"  font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}

local seperator_dif = wibox.widget {
     markup = '<span foreground="#191724" background="#31748F" font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}


local seperator_col = wibox.widget {
     markup = '<span foreground="#191724" background="#282A36" font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}

local seperator_col_dif = wibox.widget {
     markup = '<span foreground="#282A36" background="#191724" font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}

local seperator_fs = wibox.widget {
     markup = '<span foreground="#2E3440" background="#191724" font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}

local seperator_fs_diff = wibox.widget {
     markup = '<span foreground="#191724" background="#2E3440" font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}

local seperator_black = wibox.widget {
     markup = '<span foreground="#191724"  font="FiraCode Nerd Font Mono 38"></span>',
     widget = wibox.widget.textbox,
}
